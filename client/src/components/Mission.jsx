...
const Mission = function() {
  return (
    <div id={'mission'} className={'info texture v'}>
      ...
      with tools that enable and encourage sustainable growth by building synergistic systems to act in the interest of life in general.
      <br/><br/>
      ...
      and we need to use these technologies that we've created to grant people the means to survive in their own right,
